<template>
  <div class="flex items-center w-full md:w-80 p-3 bg-white rounded-md shadow-xl mb-4 border-t-4" :class="`border-${notification.type}`">
    ...
    <div class="me-2">
      ...
      <p class="mb-2 text-sm text-slate-500">{{ notification.message }}</p>
    </div>
